    ...
    return (
        <div className="flex min-h-screen bg-white">
                ...
                <div className="mx-auto w-full max-w-sm lg:w-96">
                    <div>
                        ...
                        <p className="mt-2 text-sm text-gray-600">
                            ...
                            <Link href="/login" className="font-semibold text-[#1B5E20] hover:text-[#14532B] transition-colors">
                                Sign in
                            </Link>
                        </p>
                    </div>
            ...
            <div className="relative hidden w-0 flex-1 lg:block bg-[#1B5E20]">
                <div className="absolute inset-0 h-full w-full object-cover rounded-l-3xl shadow-[-10px_0_20px_rgba(0,0,0,0.1)] bg-gradient-to-tr from-[#14532B] via-[#1B5E20] to-[#22C558] overflow-hidden">
                    {/* Decorative abstract elements */}
                    <div className="absolute top-1/3 left-1/3 w-96 h-96 bg-white opacity-[0.03] rounded-full blur-3xl mix-blend-overlay animate-pulse"></div>
                    <div className="absolute bottom-1/4 right-1/4 w-[600px] h-[600px] bg-white opacity-[0.05] rounded-full blur-3xl mix-blend-overlay"></div>

                    <div className="absolute bottom-0 left-0 p-16 w-full text-white">
                        <h2 className="text-4xl font-bold tracking-tight mb-4">Grow with Data.</h2>
                        <p className="text-lg text-white/80 max-w-xl">
                            Join your team on Sprout Dashboard. Gain real-time visibility into development cycles and accelerate delivery pipelines.
                        </p>
                    </div>
                </div>
            </div>
